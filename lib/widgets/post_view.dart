...
class PostView extends StatelessWidget {
  ...
  const PostView({Key? key, required this.post, required this.isInView})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          if (post.type == 'Photo')
            Container(
                color: Colors.black,
                child: Center(child: Image.network('${post.getCover()}')))
            ...
            Stack(
              ...
              children: [
                VideoView(
                  videoUrl: '${post.images?.image460sv?.url}',
          ...
          Row(
            children: [
              ...
              Expanded(
                child: MaterialButton(
                  onPressed: () {
                    Navigator.of(context).pushNamed('$CommentPage', arguments: post);
                  },
                  child: Row(
                    children: [
